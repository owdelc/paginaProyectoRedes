    ...
    <body>
      <div classNameName="align-middle">
        ...
        <a href="#" className="block p-6 max-w-5xlsm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <p classNameName="mb-3 font-normal text-black ">Las tarjetas Rack-O están numeradas del 1 al 60. En este caso de 4 jugadores, se utilizan las 60 tarjetas.</p>

            <h3 className="mb-2 text-xl font-bold tracking-tight text-blue-50 ">Rejillas</h3>
            <p classNameName="mb-3 font-normal text-black ">Cada jugador usa un estante. Los números que aparecen en cada estante: 5, 10, 15, 20, 25, 30, 35, 40, 45 y 50 se utilizan solo para puntuar.</p>

            <h3 className="mb-2 text-xl font-bold tracking-tight text-blue-50 ">Acuerdo</h3>
            <p classNameName="mb-3 font-normal text-black ">Corte para el trato. Primero se reparten cartas bajas. El crupier baraja las cartas y reparte diez a todos los jugadores.</p>
        ...
        <a href="#" className="block p-6 max-w-5xlsm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <p classNameName="mb-3 font-normal text-black ">Cuando se intercambian tarjetas, el jugador debe colocar la nueva tarjeta en la ranura de la que se toma la tarjeta anterior.</p>
            <p classNameName="mb-3 font-normal text-black ">Si la Pila se agota antes de que cualquier jugador haga Rack-O, la pila de Descarte se voltea y se usa como Pila de nuevo.</p>
        </a>
        ...
        <a href="#" className="block p-6 max-w-5xlsm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h2 className="mb-2 text-2xl font-bold tracking-tight text-blue-50 ">Fin del juego</h2>
              ...
              <p classNameName="mb-3 font-normal text-black ">Ya que la tarjeta 37 en la ranura # 30 es seguida por la tarjeta 22 en la ranura # 35. No se puntúan las últimas cuatro cartas del estante aunque estén colocadas correctamente.</p>
              <p classNameName="mb-3 font-normal text-black ">A veces, un jugador puede anotar solo 5 puntos en una ronda, porque la tarjeta en la ranura # 10 es más baja que la tarjeta en la ranura # 5; aunque las nueve cartas restantes estén en orden.</p>
              <p classNameName="mb-3 font-normal text-black ">A veces, un jugador puede anotar solo 5 puntos en una ronda, porque la tarjeta en la ranura # 10 es más baja que la tarjeta en la ranura # 5; aunque las nueve cartas restantes estén en orden.</p>
        </a>
